...
- **PENDING FOLLOW-UP**: Widget source files (src/widget/*, src/calc/*) still reference legacy v10 DealTerms/DealResults fields — root build fails until widget layer is migrated in a separate ticket
