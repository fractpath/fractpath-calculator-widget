 ...
 */
function toDealTerms(inputs: ScenarioInputs): import("../packages/compute/src/index.js").DealTerms {
 ...
 * Now delegates settlement math to ../packages/compute/src/index.js (single source of truth).
 */
